...
import {ProductBindInfoCountDTO} from "../../../admin/components/product/service/productBindInfoCountDTO";
import {Router} from "@angular/router";

@Component({
  selector: 'app-actual-tour',
  templateUrl: './actual-tour.component.html',
  styleUrls: ['./actual-tour.component.css']
})
